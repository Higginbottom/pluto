...
data["f_uv"]=0.7
data["f_x"]=0.3 #This is the proportion of disk flux we assume comes from the middle as X-rays
...
#    subprocess.check_call("cp directional_flux_z_opt_thin.dat directional_flux_z.dat",shell=True)   
    ...
    print ("Creating heatcool files")
    pps.pre_calc(ifile)
    print ("Created heatcool files")
