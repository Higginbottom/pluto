...
def pre_calc(ifile,radforce=0):
	...
	for i in range(len(heatcool["rho"])):
		...
		if radforce:
#			print "TEST1 ",heatcool["rad_f_w"][i]/heatcool["rho"][i]/heatcool["vol"][i],((flux["F_vis_x"][i]+flux["F_UV_x"][i]+flux["F_Xray_x"][i])*c.sigma_T.cgs.value*heatcool["ne"][i]/heatcool["rho"][i]/c.c.cgs.value),heatcool["rad_f_w"][i]/heatcool["rho"][i]/heatcool["vol"][i]/((flux["F_vis_x"][i]+flux["F_UV_x"][i]+flux["F_Xray_x"][i])*c.sigma_T.cgs.value*heatcool["ne"][i]/heatcool["rho"][i]/c.c.cgs.value)
#			print "TEST2 ",heatcool["rad_f_z"][i]/heatcool["rho"][i]/heatcool["vol"][i],((flux["F_vis_z"][i]+flux["F_UV_z"][i]+flux["F_Xray_z"][i])*c.sigma_T.cgs.value*heatcool["ne"][i]/heatcool["rho"][i]/c.c.cgs.value),heatcool["rad_f_z"][i]/heatcool["rho"][i]/heatcool["vol"][i]/((flux["F_vis_z"][i]+flux["F_UV_z"][i]+flux["F_Xray_z"][i])*c.sigma_T.cgs.value*heatcool["ne"][i]/heatcool["rho"][i]/c.c.cgs.value)

			print flux["F_vis_z"][i],flux["F_UV_z"][i],flux["F_Xray_z"][i],c.sigma_T.cgs.value,heatcool["ne"][i],heatcool["rho"][i],c.c.cgs.value
